...
const socialLinks = [
  { label: 'X', href: 'https://x.com/designlabz', Icon: XIcon },
  { label: 'LinkedIn', href: 'https://linkedin.com/company/designlabz', Icon: Linkedin },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mb-4 text-sm leading-relaxed text-ink-soft">
              AI Graphic Design Tool — create polished logos, banners, and
              social graphics in minutes, no design skills required.
            </p>
        ...
        <div className="mt-8 border-t border-primary/10 pt-8 text-center">
          <p className="text-sm text-ink-muted">
            Copyright © DesignLabz 2026 All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
