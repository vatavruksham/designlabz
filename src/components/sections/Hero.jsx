  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-surface-100 via-surface-50 to-surface-100">
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_30%,rgba(244,63,94,0.12),transparent_50%),radial-gradient(ellipse_at_85%_60%,rgba(251,146,60,0.10),transparent_45%)]" />
      </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="text-center lg:text-left">
            ...
            <h1
              ...
              style={stagger(80)}
            >
              Create Logos, Banners &amp; Social Graphics{' '}
            ...
            <p
              ...
              style={stagger(160)}
            >
              Design polished brand visuals in minutes. Describe your brand and
              vision — AI generates on-brand logos, banner layouts, and social
              graphic packs ready to publish.
            </p>
            ...
            <p
              ...
              style={stagger(300)}
            >
              No signup needed — test the live AI design studio below.
            </p>
          </div>
          ...
          <div className={`relative ${enter()}`} style={stagger(320)}>
            <div className="overflow-hidden rounded-3xl border border-primary/15 bg-white/65 p-3 shadow-card backdrop-blur-xl">
              <img
                src="/images/hero/ai-design-studio.jpg"
                alt="AI graphic design studio showing colorful logo and banner mockups on screen"
                loading="eager"
              ...
              <div className="mt-3 flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 px-4 py-2.5 text-center text-sm font-medium text-ink-soft">
                ...
                <span>Prompt → AI design → export-ready graphic</span>
              </div>
            </div>
          </div>
        </div>
