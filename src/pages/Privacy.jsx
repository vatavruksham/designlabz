...
export default function Privacy() {
  useDocumentTitle('Privacy Policy', 'DesignLabz privacy policy — how we collect, use, and protect your data.');
          ...
          <div className="glass-card rounded-xl p-8 space-y-6">
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                ...
                We also collect usage data about how you interact with DesignLabz, including
                designs generated, features used, and session duration.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                We use your information to provide and improve our AI design services,
