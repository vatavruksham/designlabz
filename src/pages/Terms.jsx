...
export default function Terms() {
  useDocumentTitle('Terms of Service', 'DesignLabz terms of service — usage guidelines and service agreement.');
          ...
          <div className="glass-card rounded-xl p-8 space-y-6">
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                By accessing or using DesignLabz, you agree to be bound by these Terms of Service.
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                DesignLabz provides AI-powered graphic design generation tools including logos,
                banners, and social graphics. We reserve the right to modify, suspend, or
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                All designs generated through DesignLabz are your property. You retain full
                commercial rights to use, modify, and distribute generated content. We do not
                claim ownership of your brand materials.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                You agree not to use DesignLabz to generate content that is illegal, harmful,
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                DesignLabz is provided "as is" without warranties of any kind. We are not liable
            ...
            <section>
              ...
              <p className="text-ink-soft leading-relaxed">
                For questions about these terms, contact us at support@designlabz.online.
              </p>
            </section>
          </div>
        </AnimateOnScroll>
