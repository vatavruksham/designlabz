...
export default function Pricing() {
  useDocumentTitle('Pricing', 'DesignLabz pricing plans — Starter $14/mo, Pro $29/mo, and Business $79/mo for every brand stage.');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll>
          <SectionHeading
            ...
            subtitle="Choose the plan that fits your brand. No hidden fees, cancel anytime."
          />
        </AnimateOnScroll>
        ...
        <AnimateOnScroll>
          <div className="glass-card rounded-2xl p-8 text-center max-w-2xl mx-auto mb-20">
            ...
            <p className="text-ink-soft leading-relaxed">
              Not happy with DesignLabz? Get a full refund within 14 days — no
              questions asked. Every plan includes commercial rights to use your
              generated designs for branding, marketing, and social media.
            </p>
          </div>
        </AnimateOnScroll>
