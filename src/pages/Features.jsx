    ...
    <div className="py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateOnScroll>
          <SectionHeading
            eyebrow="Features"
            title="Powerful AI Design Tools"
            subtitle="Everything you need to craft polished, on-brand visuals without a design team."
          />
        </AnimateOnScroll>
              ...
              >
                <div className="w-full lg:w-1/2">
                  <div className="relative rounded-2xl overflow-hidden shadow-card group">
                    <img
                      src={feature.image}
                      alt={`${feature.title} — DesignLabz AI graphic design feature`}
        ...
        <AnimateOnScroll delay={200}>
          <div className="mt-20 text-center">
            ...
            <p className="text-ink-soft mb-6 max-w-xl mx-auto">
              Try our AI design studio right now — no signup required.
            </p>
