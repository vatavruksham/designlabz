...
export default function Login() {
  ...
  useDocumentTitle(isLogin ? 'Login' : 'Register', 'Access your DesignLabz account or create a new one.');
        ...
        <AnimateOnScroll>
          <div className="glass-card rounded-2xl p-8">
            ...
            <p className="text-sm text-ink-soft text-center mb-6">
              {isLogin
                ? 'Sign in to access your DesignLabz dashboard.'
                : 'Start creating on-brand visuals with AI today.'}
            </p>
